...
% ENTROPY RETENTION COMPARISON ACROSS SPATIAL RESOLUTION
%
% Each feature:
% Column 1 = filename
% Column 2 = 1024
...
%% =========================================================
% STEP 4
% GET FILENAMES FROM ENTROPY RETENTION DATA
%% =========================================================

fileNames = ...
    EntropyRetention_data(:,1);
...
entropyretention_noncancer = ...
    EntropyRetention_data(nonCancerIndex,2:6);


entropyretention_noncancer = ...
    cell2mat(entropyretention_noncancer);


entropyretention_cancer = ...
    EntropyRetention_data(cancerIndex,2:6);


entropyretention_cancer = ...
    cell2mat(entropyretention_cancer);
...
clearvars -except entropyretention_cancer ...
    entropyretention_noncancer resolutions
...
fprintf( ...
    ...
    size(entropyretention_noncancer,1), ...
    size(entropyretention_noncancer,2));


fprintf( ...
    'Cancer matrix size = %d x %d\n', ...
    size(entropyretention_cancer,1), ...
    size(entropyretention_cancer,2));
...
mean_cancer = ...
    mean(entropyretention_cancer,1,'omitnan');


mean_noncancer = ...
    mean(entropyretention_noncancer,1,'omitnan');
...
std_cancer = ...
    std(entropyretention_cancer,0,1,'omitnan');


std_noncancer = ...
    std(entropyretention_noncancer,0,1,'omitnan');
...
fprintf('Cancer mean Entropy Retention:\n');

disp(mean_cancer);


fprintf('Non-cancer mean Entropy Retention:\n');
...
title( ...
    'Entropy Retention vs Spatial Resolution', ...
    'FontSize',14, ...
    'FontWeight','bold');
