...
% SSIM COMPARISON ACROSS SPATIAL RESOLUTION
%
% SSIM_data:
% Column 1 = filename
% Column 2 = 1024
...
ssim_noncancer = ...
    SSIM_data(nonCancerIndex,2:6);


ssim_noncancer = ...
    cell2mat(ssim_noncancer);


ssim_cancer = ...
    SSIM_data(cancerIndex,2:6);


ssim_cancer = ...
    cell2mat(ssim_cancer);
...
clearvars -except ssim_cancer ...
    ssim_noncancer resolutions
...
fprintf( ...
    ...
    size(ssim_noncancer,1), ...
    size(ssim_noncancer,2));
...
mean_cancer = ...
    mean(ssim_cancer,1,'omitnan');


mean_noncancer = ...
    mean(ssim_noncancer,1,'omitnan');
...
std_cancer = ...
    std(ssim_cancer,0,1,'omitnan');


std_noncancer = ...
    std(ssim_noncancer,0,1,'omitnan');
...
fprintf('Cancer mean SSIM:\n');

disp(mean_cancer);


fprintf('Non-cancer mean SSIM:\n');
