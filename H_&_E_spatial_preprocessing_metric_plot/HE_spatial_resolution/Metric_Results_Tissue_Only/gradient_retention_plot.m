...
% GRADIENT RETENTION COMPARISON ACROSS SPATIAL RESOLUTION
%
...
%% =========================================================
% STEP 4
% GET FILENAMES FROM GRADIENT RETENTION DATA
%% =========================================================

fileNames = ...
    GradientRetention_data(:,1);
...
gradientretention_noncancer = ...
    GradientRetention_data(nonCancerIndex,2:6);


gradientretention_noncancer = ...
    cell2mat(gradientretention_noncancer);


gradientretention_cancer = ...
    GradientRetention_data(cancerIndex,2:6);


gradientretention_cancer = ...
    cell2mat(gradientretention_cancer);
...
clearvars -except gradientretention_cancer ...
    gradientretention_noncancer resolutions
...
fprintf( ...
    ...
    size(gradientretention_noncancer,1), ...
    size(gradientretention_noncancer,2));


fprintf( ...
    'Cancer matrix size = %d x %d\n', ...
    size(gradientretention_cancer,1), ...
    size(gradientretention_cancer,2));
...
mean_cancer = ...
    mean(gradientretention_cancer,1,'omitnan');


mean_noncancer = ...
    mean(gradientretention_noncancer,1,'omitnan');
...
std_cancer = ...
    std(gradientretention_cancer,0,1,'omitnan');


std_noncancer = ...
    std(gradientretention_noncancer,0,1,'omitnan');
...
fprintf('Cancer mean Gradient Retention:\n');

disp(mean_cancer);


fprintf('Non-cancer mean Gradient Retention:\n');
...
title( ...
    'Gradient Retention vs Spatial Resolution', ...
    'FontSize',14, ...
    'FontWeight','bold');
