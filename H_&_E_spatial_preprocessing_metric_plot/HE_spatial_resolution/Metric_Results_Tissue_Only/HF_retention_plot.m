...
% HIGH-FREQUENCY RETENTION COMPARISON ACROSS SPATIAL RESOLUTION
%
% HFRetention_data:
% Column 1 = filename
% Column 2 = 1024
...
%% =========================================================
% STEP 4
% GET FILENAMES FROM HF RETENTION DATA
%% =========================================================
...
hfretention_noncancer = ...
    HFRetention_data(nonCancerIndex,2:6);


hfretention_noncancer = ...
    cell2mat(hfretention_noncancer);


hfretention_cancer = ...
    HFRetention_data(cancerIndex,2:6);


hfretention_cancer = ...
    cell2mat(hfretention_cancer);
...
clearvars -except hfretention_cancer ...
    hfretention_noncancer resolutions
...
fprintf( ...
    ...
    size(hfretention_noncancer,1), ...
    size(hfretention_noncancer,2));


fprintf( ...
    'Cancer matrix size = %d x %d\n', ...
    size(hfretention_cancer,1), ...
    size(hfretention_cancer,2));
...
mean_cancer = ...
    mean(hfretention_cancer,1,'omitnan');


mean_noncancer = ...
    mean(hfretention_noncancer,1,'omitnan');
...
std_cancer = ...
    std(hfretention_cancer,0,1,'omitnan');


std_noncancer = ...
    std(hfretention_noncancer,0,1,'omitnan');
...
fprintf('Cancer mean HF Retention:\n');

disp(mean_cancer);


fprintf('Non-cancer mean HF Retention:\n');
...
title( ...
    'High-Frequency Retention vs Spatial Resolution', ...
    'FontSize',14, ...
    'FontWeight','bold');
