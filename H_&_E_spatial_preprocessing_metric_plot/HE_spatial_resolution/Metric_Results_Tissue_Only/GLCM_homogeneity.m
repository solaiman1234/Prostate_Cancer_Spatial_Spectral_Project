...
% GLCM HOMOGENEITY COMPARISON ACROSS SPATIAL RESOLUTION
%
...
%% =========================================================
% STEP 4
% GET FILENAMES FROM GLCM HOMOGENEITY DATA
%% =========================================================

fileNames = ...
    GLCMHomogeneity_data(:,1);
...
glcmhomogeneity_noncancer = ...
    GLCMHomogeneity_data(nonCancerIndex,2:6);


glcmhomogeneity_noncancer = ...
    cell2mat(glcmhomogeneity_noncancer);


glcmhomogeneity_cancer = ...
    GLCMHomogeneity_data(cancerIndex,2:6);


glcmhomogeneity_cancer = ...
    cell2mat(glcmhomogeneity_cancer);
...
clearvars -except glcmhomogeneity_cancer ...
    glcmhomogeneity_noncancer resolutions
...
fprintf( ...
    ...
    size(glcmhomogeneity_noncancer,1), ...
    size(glcmhomogeneity_noncancer,2));


fprintf( ...
    'Cancer matrix size = %d x %d\n', ...
    size(glcmhomogeneity_cancer,1), ...
    size(glcmhomogeneity_cancer,2));
...
mean_cancer = ...
    mean(glcmhomogeneity_cancer,1,'omitnan');


mean_noncancer = ...
    mean(glcmhomogeneity_noncancer,1,'omitnan');
...
std_cancer = ...
    std(glcmhomogeneity_cancer,0,1,'omitnan');


std_noncancer = ...
    std(glcmhomogeneity_noncancer,0,1,'omitnan');
...
fprintf('Cancer mean GLCM Homogeneity:\n');

disp(mean_cancer);


fprintf('Non-cancer mean GLCM Homogeneity:\n');
...
title( ...
    'GLCM Homogeneity vs Spatial Resolution', ...
    'FontSize',14, ...
    'FontWeight','bold');
